...
```
It make sense since mammals do not have eggs, therefore the egg mass is NA. NA may be interrepted as "do not exist". However, about why does reptiles have higher NAs than bird, I do not have any clue.
...
## 4 ter        1104     16.3
```
It may be representing that the species do not live in that kind of area (For example, having NA in aquatic may mean the species is not aquatic).
