...
fisheries$country<-factor(fisheries$country)
fisheries$isscaap_group_number<-factor(fisheries$isscaap_group_number)
fisheries$asfis_species_name<-factor(fisheries$asfis_species_name)
```
...
```r
count(distinct(fisheries_tidy,asfis_species_number))
```
...
## # ℹ 183 more rows
```
China has the most overall catch in 2000.
...
## # ℹ 27 more rows
```
Morocco has the most sardines catch between 1990 to 2000.
...
## 16 Viet Nam                              0
```
The top five countries is India, China, Spain, Algeria, and France.
...
## # ℹ 1,462 more rows
```
The most caught species is Theragra chalcogramma.
...
##    <fct>                               <dbl>
##  1 Osteichthyes                       262046
##  2 Trichiurus lepturus                 83434
##  3 Crustacea                           48740
##  4 Mollusca                            42718
##  5 Engraulis japonicus                 28365
##  6 Decapterus spp                      17834
##  7 Scomber japonicus                   17402
##  8 Acetes japonicus                    16294
##  9 Cantherhines (=Navodon) spp         15741
## 10 Scomberomorus spp                   13824
## # ℹ 79 more rows
```
