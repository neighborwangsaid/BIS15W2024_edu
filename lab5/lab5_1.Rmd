...
```{r}
selectedmammals<-select(mammals,'species','genus',`mass`, `gestation`, `newborn`)

```

```{r}
comparemammals<-filter(selectedmammals, genus== 'Lophocebus'|genus=='Erythrocebus'|genus=='Macaca')
```
