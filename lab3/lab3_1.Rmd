...
hsprings<-cbind.data.frame(hsprings,depth_ft)
hsprings
```

4. Calculate the mean temperature of all of the temperature measurements.
```{r}
mean_temp<-mean(hsprings$temp_C)
mean_temp
```
